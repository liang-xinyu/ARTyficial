%% load the beta values and grades on hedonic value component
load('ART_G2_4lvl_predictiondata.mat')
grad_num = 4;
nsub = 34;
...
% save("ART_G2_PrePerfomance.mat","predicted_ratings_reshaped","YY","Yfit");
...
[~, stats_boot] = predict(AATpredition,  'algorithm_name', 'cv_svr', 'nfolds', 1, 'error_type', 'mse', 'bootweights', 'bootsamples', 10000,'savebootweights');
